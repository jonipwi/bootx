...
BootX has enough documented principles to begin **development preparation and synthetic prototyping**. Its research is not scientifically complete, because benefit, harm, reliability, physical safety, privacy, dependency, and family/community outcomes have not been measured in a robotics prototype or representative field study.
...
5. Create synthetic personal, family, fraud, privacy, outage, and attack scenarios with provenance.
6. Implement the measurement harness for `POR`, `HOR`, confidence intervals, and subgroup results.
7. Create the robotics hazard log and system threat/data-flow models.
8. Prototype memory inspection, correction, export, expiry, and deletion.
9. Implement local authentication, audit, safe stop, and rollback.
10. Compare non-AI, rule-based, and bounded-AI assistance.
